...
public class AlquilerCRUD {
    ...
    // Metodo privado para no repetir codigo al crear objetos Alquiler desde la base de datos
    private Alquiler crearAlquilerDesdeResultSet(ResultSet rs) throws SQLException {
        ...
        Alquiler alquiler = new Alquiler(
                ...
                //metodo desde bd -> para transformar ese boolean en el enum y saber a cual me refiero
